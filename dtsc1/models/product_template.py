...
class ResPartner(models.Model):
    ...
    make_ori_product_id = fields.Many2one("product.template",string="基礎扣料物",domain=[('purchase_ok',"=",True)])
    can_be_expensed = fields.Boolean(string="可用於費用")
...
class ProductMakeTypeRel(models.Model):
    ...
    make_type_id = fields.Many2one("dtsc.maketype" , "後加工方式")
